...
public class RestaurantEditor extends EditorPanel {
    ...
    private void initComponents() {
        ...
        this.nameTextField.addKeyListener(new Validate(this.nameTextField, text -> context.perform(_ -> this.restaurant.setName(text))));
        this.addressLabel = new JLabel(textContent.get(context.getLanguage(), TextContent.Key.ADDRESS));
        this.addressTextField = new JTextField(restaurant.getAddress());
        this.addressTextField.addKeyListener(new Validate(this.addressTextField, text -> context.perform(_ -> this.restaurant.setAddress(text))));
        this.phoneLabel = new JLabel(textContent.get(context.getLanguage(), TextContent.Key.PHONE));
        this.phoneTextField = new JTextField(restaurant.getPhone());
        this.phoneTextField.addKeyListener(new Validate(this.phoneTextField, text -> context.perform(_ -> this.restaurant.setPhone(text))));
        this.emailLabel = new JLabel(textContent.get(context.getLanguage(), TextContent.Key.EMAIL));
        this.emailTextField = new JTextField(restaurant.getEmail());
        this.emailTextField.addKeyListener(new Validate(this.emailTextField, text -> context.perform(_ -> this.restaurant.setEmail(text))));
        ...
        this.taxIDTextField.addKeyListener(new Validate(this.taxIDTextField, text -> context.perform(_ -> this.restaurant.setTaxID(text))));
        this.SIRENLabel = new JLabel(textContent.get(context.getLanguage(), TextContent.Key.SIREN));
        this.SIRENTextField = new JTextField(restaurant.getSIREN());
        this.SIRENTextField.addKeyListener(new Validate(this.SIRENTextField, text -> context.perform(_ -> this.restaurant.setSIREN(text))));
        ...
        this.latePenaltyPolicyField.addKeyListener(new Validate(this.latePenaltyPolicyField, text -> context.perform(_ -> this.restaurant.setLatePenaltyPolicy(text))));
    }
